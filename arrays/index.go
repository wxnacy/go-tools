...
// StringIndex Returns the index position of the string val in array
func StringIndex(array []string, val string) (index int) {
	index = -1
...
// IntIndex Returns the index position of the int val in array
func IntIndex(array []int, val int) (index int) {
	index = -1
	for i := 0; i < len(array); i++ {
		if array[i] == val {
			index = i
...
// Int64Index Returns the index position of the int64 val in array
func Int64Index(array []int64, val int64) (index int) {
	index = -1
	for i := 0; i < len(array); i++ {
		if array[i] == val {
			index = i
...
// Int32Index Returns the index position of the int32 val in array
func Int32Index(array []int32, val int32) (index int) {
	index = -1
	for i := 0; i < len(array); i++ {
		if array[i] == val {
			index = i
